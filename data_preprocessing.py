...
encoder_Nationality = joblib.load('model/encoder_Nationality.joblib')
...
def data_preprocessing(data):
    ...
    df["Nationality"] = data["Nationality"]
    ...
    df[["pc1_1", "pc1_2"]] = pca_1.transform(data[pca_kolom_numerikal_1])
    ...
    df[["pc2_1", "pc2_2"]] = pca_2.transform(data[pca_kolom_numerikal_2])
